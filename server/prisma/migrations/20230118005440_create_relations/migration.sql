...
INSERT INTO "new_day_habist" ("day_id", "habit_id", "id") SELECT "day_id", "habit_id", "id" FROM "day_habist";
DROP TABLE "day_habist";
ALTER TABLE "new_day_habist" RENAME TO "day_habist";
